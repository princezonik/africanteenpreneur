<header x-data="{ open: false }" class="absolute top-0 left-0 right-0 z-50 bg-transparent">
            <div class="container mx-auto flex justify-between items-center py-6 px-4">
                ...
                >
                        ...
                        <div x-show="openWho" x-transition x-cloak
                            ...
                            <div class="flex-1">
                                ...
                                <ul class="space-y-2 text-gray-600">
                                    ...
                                    <li><a href="#" class="hover:text-orange-500">Our History</a></li>
                            ...
                            <div class="flex-1">
                                ...
                                <ul class="space-y-2 text-gray-600">
                                    <li><a href="#" class="hover:text-orange-500">Nigeria</a></li>
                                    <li><a href="#" class="hover:text-orange-500">U.S.</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="relative">
                        ...
                        <div x-show="openGive" x-transition x-cloak
                            ...
                            <ul class="space-y-2 text-gray-600">
                                <li><a href="#" class="hover:text-orange-500">Become a Member</a></li>
                ...
                <a href="#" class="hidden md:inline-block bg-orange-400 hover:bg-orange-500 text-white px-6 py-2 rounded-full font-semibold transition text-sm sm:text-base">
                    DONATE
                </a>
            </div>
